...
Ext.define('Ext.app.Portal', {
    ...
    uses: ['Ext.app.PortalPanel', 'Ext.app.PortalColumn', 'Ext.app.GridPortlet', 'Ext.app.ChartPortlet', 'Ext.macros.SearchResults'],
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        items: [{
                            ...
                            title: 'Search Result',
                            tools: this.getTools(),
                            items: Ext.create('Ext.macros.SearchResults'),
                            listeners: {
